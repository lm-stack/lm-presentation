...
import Cover from '@/components/slides/CoverBold.astro';
...
<Cover
  title="Growth Marketing 2025"
  subtitle="Démo des modules de contenu réutilisables Lausanne Marketing"
  eyebrow="Catalogue interne · Mai 2026"
  highlight="Marketing"
  watermark="GM"

...
| Fichier | Contenu |
|---------|---------|
| `slides.md` | Règles visuelles INTANGIBLES : zone titre `SlideTitle`, centrage vertical (titre fixe en haut), safe area 48px, border-radius 4px, drop-shadows légères, header ExecEd, fond pearl uniforme, sous-titre `SubSectionHero` sur une ligne, titre `WorkshopHero` figé sur « Workshop » |
